export default function Footer() {
    return (
        <footer className="bg-gradient-to-r from-purple-50 via-[#e6bcff] to-purple-50 mt-8">
            <div className="max-w-screen-xl px-12 md:px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <img src="/icons/zakaa-logo.png" className="mr-5 h-6" alt="logo" />
