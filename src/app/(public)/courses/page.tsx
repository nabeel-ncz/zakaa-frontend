                    ...
                    {courses?.map((item: any) => (
                        <div className="flex items-center justify-center secondary-bg rounded-md overflow-hidden px-2 py-3">
                            ...
                            <div className="w-2/3 ps-4 flex flex-col">
                                <h2 className="font-light text-sm mb-4">by <span className="font-medium">{item.instructorRef}</span></h2>
                                <h2 className="font-medium text-xl line-clamp-1">{item.title}</h2>
