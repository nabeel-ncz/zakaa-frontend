...
export default function LiveStreamOpenScreen(
    {
        getMeetingAndToken,
        setMode
    }: {
            ...
            <div className="w-full min-h-screen bg-white relative p-4">
                {joinModalOpen && (
                    ...
                    <div className="absolute w-96 h-60 bg-white rounded shadow-xl p-4">
                        ...
                        <button
                            ...
                            onClick={() => { getMeetingAndToken() }}>Create New Meeting</button>
                    </div>
                ...
                <div className="flex flex-col items-center justify-center border border-gray-200 rounded p-4">
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <button onClick={toggleModal} className="px-4 py-2 primary-bg hover:bg-purple-800 rounded text-white text-sm font-medium">Start Streaming</button>
                    </div>
